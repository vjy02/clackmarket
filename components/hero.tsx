    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 py-20">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto text-left">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="font-semibold text-gray-900">Comnmunity Driven</div>
              <p className="text-gray-600 text-sm mt-1">
                Listings made by fellow keeb enthusaists, no middle man.
              </p>
            </div>
